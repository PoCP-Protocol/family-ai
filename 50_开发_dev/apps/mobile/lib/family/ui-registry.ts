...
export const FAMILY_SCREENS: FamilyScreenDefinition[] = [
  ...
  { id: "UI-02-result", title: "测评完成", subtitle: "确认免费家庭测评已提交，并进入家庭支持方向解读", tab: "growth", loop: "评估", featurePoints: ["测评回执", "来源说明", "边界说明", "支持方向入口"], primaryAction: "查看支持方向", primaryTarget: "UI-03", baseline: "core-02-assessment-result" },
  { id: "UI-03", title: "家庭成长解读", subtitle: "把事实、视角、假设和建议分开说明", tab: "growth", loop: "评估", featurePoints: ["已确认事实", "家长视角", "可能视角", "下一步可试"], primaryAction: "查看可选支持方案", primaryTarget: "UI-04", baseline: "core-03-ai-report" },
  ...
  { id: "UI-08", title: "家庭过程回顾", subtitle: "回看行动、观察与反思的来源", tab: "growth", loop: "评估", featurePoints: ["过程记录", "观察方向", "证据来源", "需要进一步确认的内容"], primaryAction: "查看可选支持方案", primaryTarget: "UI-04", baseline: "growth-02-ai-report" },
