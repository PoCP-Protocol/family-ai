...
export default function AnnualCompanionScreen() {
  ...
  return (
    <ScreenContainer edges={["left", "right", "bottom"]}>
      <Stack.Screen options={{ headerShown: true, title: "年度陪伴", headerBackTitle: "返回" }} />
      <FlatList
