  ...
  return (
    <ScreenContainer edges={["left", "right", "bottom"]}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <Pressable onPress={handlePrimary} style={({ pressed }) => [styles.completeButton, pressed && styles.pressed]}><Text style={styles.completeText}>{isStarted ? "完成今日任务" : "开始今日任务"}</Text></Pressable>
