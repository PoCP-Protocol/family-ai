...
export default function TeacherZoneScreen() {
  ...
  return (
    <ScreenContainer edges={["left", "right", "bottom"]}>
      <Stack.Screen options={{ headerShown: true, title: "名师专区", headerBackTitle: "返回" }} />
      <FlatList
          ...
          <View style={styles.header}>
            ...
            <View style={styles.hero}>
              <View style={styles.heroCopy}>
                <Text style={styles.heroTitle}>名师在线，陪你梳理家庭成长难题</Text>
                ...
                <Pressable onPress={() => router.push("/ui/UI-21" as Href)} style={({ pressed }) => [styles.heroAction, pressed && styles.pressed]}>
                  <Text style={styles.heroActionText}>准备咨询需求</Text>
                </Pressable>
              </View>
            ...
            <View style={styles.sectionHeading}>
              ...
              <Text style={[styles.sectionMeta, { color: colors.muted }]}>按家庭需要选择</Text>
            </View>
            ...
            <View style={styles.sectionHeading}>
              ...
              <Text style={[styles.sectionMeta, { color: colors.muted }]}>{offerings.length} 个可了解方向</Text>
            </View>
          </View>
        }
          ...
          <View style={[styles.teacherCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            ...
            <View style={styles.teacherCopy}>
              ...
              <View style={styles.teacherActions}>
                ...
                <Pressable onPress={() => router.push(`/ui/UI-21?offeringRef=${encodeURIComponent(item.offeringRef)}` as Href)} style={({ pressed }) => [styles.primaryAction, { backgroundColor: colors.tint }, pressed && styles.pressed]}><Text style={styles.primaryText}>准备咨询</Text></Pressable>
              </View>
            </View>
          </View>
        )}
