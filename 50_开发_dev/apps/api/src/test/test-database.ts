...
export async function cleanOrchestrationTablesIfPresent(pool: pg.Pool): Promise<void> {
  const tables = [
    ...
    'case_access_grants', 'service_relationships',
    'provider_admissions', 'teacher_affiliations', 'teacher_qualifications', 'teacher_capabilities', 'teacher_profiles',
    'organization_memberships', 'organization_units', 'organization_tenant_bindings', 'organizations',
    'account_party_bindings', 'provider_profiles', 'individual_parties', 'parties',
