...
export const featuredChallenge: CommunityChallenge = {
...
export const stories: FamilyStoryCard[] = [
  {
    id: 'story-1',
    title: '那天我第一次没急着讲道理',
  ...
  {
    id: 'story-2',
    title: '第 3 天没有完成，也完成了复盘',
    anonymizedExcerpt: '匿名家庭 B：没有把未完成当成终点，而是一起找到了明天能继续的入口。',
    reviewed: true,
    consentPurpose: 'CONTENT_PUBLICATION',
  },
];
